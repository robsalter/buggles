	...
	<body>
		<div class="wrapper">
			<div class="section front">	
				...
				<div class="container">
					<div class="channels-horz">
						<ul>
							<li class="channel-horz" id="bbc-1">
								<h1>BBC 1</h1>
								<div class="gutter">
									<!-- Group <article>s (programmes) into 'm-h-group's -->
									<div class="m-h-group">
										<article class="food">
											<dl>
												<dt>Masterchef</dt>
...
-->
		...
		<script type="text/javascript">
			var carousel = new CarouselY('.channels-horz');
			carousel.init();
